...
namespace NuGet.VisualStudio.Implementation.Extensibility
{
    internal static class PackageServiceUtilities
    {
        ...
        internal static NuGetPackageManager CreatePackageManager(ISourceRepositoryProvider repoProvider, ISettings settings, IVsSolutionManager solutionManager, IDeleteOnRestartManager deleteOnRestartManager)
        {
            ...
            CancellationToken token)
        {
            ...
            try
            {
                ...
                var packageManager = CreatePackageManager(repoProvider, settings, solutionManager, deleteOnRestartManager);
